...
public class CameraPreview extends ViewGroup {
    ...
    protected void initializeAttributes(AttributeSet attrs) {
        ...
        this.marginTop = (int) styledAttributes.getDimension(R.styleable.zxing_camera_preview_zxing_framing_margin_top, -1);
        this.marginLeft = (int) styledAttributes.getDimension(R.styleable.zxing_camera_preview_zxing_framing_margin_left, -1);
    ...
    protected Rect calculateFramingRect(Rect container, Rect surface) {
        ...
        if (framingRectSize != null) {
            ...
            if (marginTop > 0) {
                intersection.top = (int) marginTop;
                intersection.bottom = (int) (framingRectSize.height + marginTop);
            }
            if (marginLeft > 0) {
                intersection.left = (int) marginLeft;
                intersection.right = (int) (framingRectSize.width + marginLeft);
            }
            return intersection;
        }
